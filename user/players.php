                                                ...
                                                <div class="row w-100">
                                                    ...
                                                    <div class="col-md-4 ">
                                                        <div class="form-group">
                                                            <label for="">Camp <span id="error-message" class=" text-danger">*</span></label>
                                                            <select id="campsD" class="selectpicker form-control campData" data-show-subtext="true" data-live-search="true" name="campId">
                                                            <option  value=""></option>
                                                            <?php 
                                                                include('./config.php');

                                                                $reg = $_SESSION['SESS_REGION_ID'];
                                                                $sqlRegion = mysqli_query($conn,'SELECT * FROM camptbl WHERE regionId="' . $reg . '" ORDER BY campName ASC');
                                                                while ($row = mysqli_fetch_assoc($sqlRegion)) {
                                                            
                                                            ?>
                                                            <option value="<?= $row['id'] ?>"><?= $row['campName'] ?></option>
                                                            <?php 
                                                                }
                                                            ?>
                                                ...
                                                <tbody>
                                                    <?php  
                                                        ...
                                                        if(isset($_POST['filter'])) {
                                                            ...
                                                            WHERE playerstbl.campId='$campId' AND playerstbl.regionId='$reg'
