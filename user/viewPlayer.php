    ...
    <?php  
        ...
        if(isset($_GET['playerId']) && !empty(isset($_GET['playerId']))) {
            ...
            $sqlPlayer = mysqli_query($conn, 'SELECT playerstbl.fullName,playerstbl.nickname,playerstbl.gender,playerstbl.contact,playerstbl.passportPicture,playerstbl.dateOfBirth,camptbl.campName,regiontbl.regionName
            FROM playerstbl
