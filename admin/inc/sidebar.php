...
<head>
	...
	<meta name="description" content="Ghana Draught Association">
			...
			<div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
					...
					<li class="sidebar-item">
                        ...
                        <i class="align-middle" data-feather="coffee"></i><span class="align-middle">Manage Camps & Regions</span>
						</a>
						<ul id="manage-camps" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							...
							<li class="sidebar-item"><a class="sidebar-link" href="./regions.php">Regions</a></li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./manageUsers.php">
