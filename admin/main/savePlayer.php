<?php 
    ...
    if(isset($_POST["savePlayer"])) {
        ...
        $sql = mysqli_query($conn, "INSERT INTO playerstbl(fullName,nickname,dateOfBirth,gender,contact,regionId,campId,userId,competitionsWon,yearWon,passportPicture) VALUES('$fullName','$nickname','$dateOfBirth','$gender','$contact','$regionId','$campId','$userId','$competitionsWon','$yearWon','$imageNameAndExtension')");
