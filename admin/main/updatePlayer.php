<?php 
    ...
    if(isset($_POST["updatePlayer"])) {
        ...
        $sql = mysqli_query($conn, "UPDATE playerstbl SET fullName='$fullName',nickname='$nickname',dateOfBirth='$dateOfBirth',gender='$gender',contact='$contact',regionId='$regionId',campId='$campId',competitionsWon='$competitionsWon',yearWon='$yearWon',passportPicture='$imageNameAndExtension' WHERE id='$playerId'");
